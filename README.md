...
Since the 1980s, CLT is an instructional design theory based in uncontroversial aspects of human cognitive architecture. In the late 1990s, Sweller et al published extensive data using this theory that warranted an extended analysis (Sweller, van Merrienboer, Paas 1998). In 2019, the same authors, reviewed the theoretical and empirical work done so far, concluding that CLT "is firmly based in our—expanding—knowledge of human cognitive architecture; (2) it is under continuous development as our knowledge of human cognition advances; (3) it leads to testable hypotheses with possible negative results leading to modifications of the theory; (4) the vast bulk of the data generated by the theory is based on randomised, controlled trials; and (5) those randomised, controlled trials provide evidence for the effectiveness of instructional procedures that can be used in a wide range of educational contexts from conventional classrooms to e-learning, teaching all age groups from very young to adult learners, with an enormous range of subject matter from medical education to English literature. 

The structures and functions of human cognitive architecture have been used to design a variety of novel instructional procedures based on the assumption that working memory load should be reduced and schema construction encouraged. This paper reviews the theory and the instructional designs generated by it. One of this is 4C/ID instructional design used in this work. Extensive research exists not only on the theories underlying the 4C/ID model, with results often summarized in specific effects and strategies. For instance, by considering human cognitive structure As point out by Sweller, van Merriënboer and Paas, 

(. utilizing the effective instructional strategies of 4C/ID, we can manage working memory load and provide appropriate guidance. This process facilitates schema development and optimizes learning outcomes. Consequently, stakeholders—including teachers, policymakers, and school administrators—can gain valuable insights to enhance teaching practices, improve learning design, and more effectively implement instructional strategies (Kirschner, 2002).

By the late 1990s, sufficient data had been collected using the theory to warrant an extended analysis resulting in the publication of Sweller et al. (Educational Psychology Review, 10, 251–296, 1998)

About bLearning... results

=====keep in mind====
State of the Art (often part of a literature review) refers to the current knowledge, recent findings, and latest developments in a specific research field. It's a review of the most up-to-date and relevant research on your topic, highlighting what has been done, what the current best practices are, and, most importantly, what the existing gaps in the knowledge are. The "state of the art" section shows that you are aware of the most recent and impactful contributions to your field. It justifies why your research is necessary by demonstrating that you are filling a gap or addressing a problem that has not yet been solved.
=====

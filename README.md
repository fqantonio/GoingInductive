...
The same analysis, the same sequence and tests was done using several samples. So, the correct result must be in between: in one end it was used **"all sample"** and in the other end the same sample but without **school and behavior effect** (this last one, for the years 2016 and 2017).

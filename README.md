...
**In practice**, remembering what the authors of 4C/ID start to make the analogy of this learning design with an ocean liner (Van Merriënboer, Clark, Croock, 2002): "huge, slow, poderous, and recuring larges amoounts of energy and a great deal of time to move...". All this work toke a lot of effort, including all the prodedure underlying the pedagogic planning: reading, testing, reading and searching, and reading again. The **4C/ID** of Van Merriënboer has a steep learning curve but it provides a consistent lighthouse during all the process, meaning a consistent managment of instructional sequences before the LMS organization. This model provides the methodology for analysis of complex cognitive skills and development of appropriate sequences of whole-tasks, real-world-problems learning situations that support gradual aqcquisition of these skills in a cognitively sustained manner. The procedure takes into account the limited processing capacity of working memory by gradually increasing the level of difficulty of whole tasks. According to this methodology, learning tasks for complex environments are organized in simple to complex sequence of task classe, with gradually dimishing levels of support/fading within each class (scafolding). Suficient supportive information is provided for general aspects of learning tasks, and just-in-time information engage students in automation for the learning goals. 
Also part-time-task-practice are offered to train constituent skills that needed to be performed at a very high level of automaticity (Kalyuga, Paas et all, 2010). 
Being that said, the course structure were organized using cmap tools (see attachment), a software online tool to develop mind maps about the overall learning structure with two dimentions:
1. In the horizontal, anolog to a time-line, it follows a concrete-to-abstract task classses (TC), each one having the to promote the aquisition of higher level conceptual schemas and mental models.
2. 
